...
def _methane_propane_parameters() -> Parameters:
    ...
    propane_catalog = Parameters.from_catalog(
        "gross-2001-propane", components=("propane",), version=1
    )
    ...
    source = SourceRecord(
        ...
        use_basis="source-backed installed parameter catalog",
    )
    domains = tuple(
...
def test_installed_provider_advertises_each_aqueous_kij_miac_contract() -> None:
    ...
    assert all(
        ...
        and capability.model_domain == "aqueous_nabr"
