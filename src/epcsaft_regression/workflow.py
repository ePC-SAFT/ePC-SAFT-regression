...
_FIGIEL_SOURCES = (
    SourceRecord(
        ...
        use_basis=(
            "primary equations and parameters for bounded water, methanol, and "
            "ethanol alkali-halide reference states"
        ),
    ),
    SourceRecord(
        source_id="nist-srd-69-water",
        citation="NIST Chemistry WebBook, SRD 69, Water, CAS 7732-18-5.",
        use_basis="water identity and molecular weight",
    ),
    SourceRecord(
        source_id="nist-srd-69-methanol",
        citation="NIST Chemistry WebBook, SRD 69, Methanol, CAS 67-56-1.",
        use_basis="methanol identity and molecular weight",
    ),
    SourceRecord(
        source_id="nist-srd-69-ethanol",
        citation="NIST Chemistry WebBook, SRD 69, Ethanol, CAS 64-17-5.",
        use_basis="ethanol identity and molecular weight",
    ),
)
...
def _figiel_aqueous_parameters(
    ...
    *,
    ...
    catalog = Parameters.from_catalog(
        ...
        components=_FIGIEL_COMPONENT_IDS,
        version=1,
    )
    born_by_component = {
